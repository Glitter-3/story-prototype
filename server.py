...
4.  **动作幅度限制**：人物动作幅度严格控制在原始姿态的15%以内，严禁出现大笑、大幅挥手、跳跃、快速转身等夸张动作；表情变化仅允许嘴角极轻微上扬级别，全程保持克制、静谧、回忆质感。
【风格关键词（必须遵守）】subtle motion only, slow gentle breathing, no laughing or exaggerated expressions, serene and still, no sudden movement, preserve original expression, calm nostalgic mood
"""
